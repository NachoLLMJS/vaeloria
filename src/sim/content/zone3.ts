// Zone 3 — Aetherthorn Peaks (levels 13-20). The Gravecallers serve Korzul
// the Gravewyrm, an ancient dragon sealed beneath the peaks. Skyreach Bastion holds
...
export const ZONE3_ZONE: ZoneDef = {
  ...
  name: 'Aetherthorn Peaks',
  zMin: 540,
  zMax: 900,
  levelRange: [13, 20],
  biome: 'peaks',
  hub: { x: 0, z: 660, radius: 20, name: 'Skyreach Bastion' },
  graveyard: { x: 15, z: 645 },
  lakes: [{ x: -70, z: 760, radius: 18 }],
  pois: [
    { x: 0, z: 660, label: 'Skyreach Bastion' },
    { x: -50, z: 590, label: 'Rimefang Ridge' },
    { x: 85, z: 615, label: 'Deepstone Burrows' },
    { x: -90, z: 700, label: 'Frostmaul Foothills' },
    { x: -130, z: 740, label: "Drogmar's War-Camp" },
    { x: 110, z: 760, label: 'Stormspire Crag' },
    { x: 55, z: 820, label: 'Wyrmcult Pavilion' },
    { x: -40, z: 830, label: 'Ashen Revenant Fields' },
    { x: 0, z: 880, label: 'Gravewyrm Sanctum' },
  ],
  welcome: 'Captain Thessaly holds the wall at Skyreach Bastion — barely.',
};

// Mountain road from Mistfen Crossing up to Skyreach Bastion, then spokes.
export const ZONE3_ROADS: { x: number; z: number }[][] = [
  [{ x: 0, z: 320 }, { x: 10, z: 450 }, { x: 0, z: 540 }, { x: 0, z: 660 }],        // Mistfen Crossing -> Skyreach Bastion
  [{ x: -6, z: 666 }, { x: -60, z: 700 }, { x: -110, z: 735 }],                     // -> ogre war-camp
  [{ x: 6, z: 668 }, { x: 70, z: 720 }, { x: 110, z: 760 }],                        // -> Stormspire Crag
...
export const ZONE3_MOBS: Record<string, MobTemplate> = {
  ...
  deeprock_kobold: {
    id: 'deeprock_kobold', name: 'Deepstone Cactoro', minLevel: 14, maxLevel: 15, family: 'kobold',
  ...
  thornpeak_ogre: {
    id: 'thornpeak_ogre', name: 'Aetherthorn Yeti', minLevel: 15, maxLevel: 16, family: 'ogre',
  ...
  ogre_crusher: {
    id: 'ogre_crusher', name: 'Aetherthorn Yeti Crusher', minLevel: 16, maxLevel: 17, family: 'ogre', elite: true,
  ...
  stormcrag_elemental: {
    id: 'stormcrag_elemental', name: 'Stormspire Crag Goleling', minLevel: 17, maxLevel: 18, family: 'elemental',
...
// ---------------------------------------------------------------------------
// NPCs (Skyreach Bastion hub)
// ---------------------------------------------------------------------------

export const ZONE3_NPCS: Record<string, NpcDef> = {
  captain_thessaly: {
    id: 'captain_thessaly', name: 'Captain Thessaly', title: 'Skyreach Bastion Captain',
  ...
  quartermaster_bree: {
    id: 'quartermaster_bree', name: 'Quartermaster Bree', title: 'Skyreach Bastion Quartermaster',
    ...
    greeting: 'Wool, hardtack, and steel-shod boots — Skyreach Bastion runs on all three, and I am short of everything.',
  },
  armorer_hode: {
...
export const ZONE3_QUESTS: Record<string, QuestDef> = {
  q_highwatch_summons: {
    ...
    text: "Vael's last words have not left me, $N: the Wyrm stirs beneath the peaks. Captain Thessaly commands the wall at Skyreach Bastion, at the head of the mountain road north. A summons stands posted at her gate — take it up, and tell her Brother Aldric is climbing the mountain behind you.",
    completionText: "Aldric's word reaches far. If the priest of the Vale is climbing the mountain himself, then it is as bad as I feared. Welcome to Skyreach Bastion, $N.",
    objectives: [{ type: 'collect', itemId: 'highwatch_summons', count: 1, label: 'Skyreach Bastion Summons' }],
  ...
  q_stalkers: {
    ...
    text: 'The Ridge Blobdogs have come down from the high snows hungry, and my patrols bleed for it. Every Blobdog you put down is a soldier I keep on the wall. Thin them, $N — twelve, to start.',
    completionText: 'Twelve fewer shadows on the ridge. The patrols will breathe easier tonight.',
    objectives: [{ type: 'kill', targetMobId: 'ridge_stalker', count: 12, label: 'Ridge Blobdog slain' }],
    xpReward: 2200, copperReward: 1000, itemRewards: {},
  },
  q_stalker_pelts: {
    id: 'q_stalker_pelts', name: 'Winter Is Coming to Skyreach Bastion',
    giverNpcId: 'quartermaster_bree', turnInNpcId: 'quartermaster_bree',
    text: 'Winter on this mountain does not knock, $N — it kicks the door in. Eight Ridge Blobdog Pelts will line enough cloaks to see the wall through the first snows. The beasts prowl the ridges flanking the road south.',
    completionText: 'Thick as my arm, these. The watch will not freeze this year — take these treads for your trouble.',
    objectives: [{ type: 'collect', itemId: 'ridge_stalker_pelt', count: 8, label: 'Ridge Blobdog Pelt' }],
  ...
  q_kobold_tunnels: {
    id: 'q_kobold_tunnels', name: 'Deepstone Trouble',
    giverNpcId: 'loremaster_caddis', turnInNpcId: 'loremaster_caddis',
    text: 'The Deepstone Cactoros at Deepstone Burrows are digging deeper than any candle-rat has business digging — straight down, as if something were calling them. Their tunnels run beneath our wall, $N. Collapse the matter: kill twelve Deepstone Cactoros.',
    completionText: 'Straight down, every shaft of it — kobolds do not dig like that on their own. I must consult my books.',
    objectives: [{ type: 'kill', targetMobId: 'deeprock_kobold', count: 12, label: 'Deepstone Cactoro slain' }],
  ...
  q_glowing_wax: {
    ...
    giverNpcId: 'quartermaster_bree', turnInNpcId: 'quartermaster_bree',
    text: 'Caddis showed me a candle taken off one of those Deepstone Cactoros — the wax glows, $N, and it is warm as a heartbeat. He wants more for study, and I want it off my requisition list. Bring back six lumps of Deepstone Cactoro Wax.',
    ...
    objectives: [{ type: 'collect', itemId: 'glowing_wax', count: 6, label: 'Deepstone Cactoro Wax' }],
    xpReward: 2500, copperReward: 1200, itemRewards: {},
  ...
  q_ogre_edges: {
    ...
    text: 'The Aetherthorn clans never come this far east — yet here they are, camped in the eastern foothills with war paint on. Somebody is paying them, $N, and ogres do not take promises. Cut twelve of them down while I find out who holds the purse.',
    completionText: 'Twelve down, and still they are not pulling back. Whoever bought them paid in something heavier than gold.',
    objectives: [{ type: 'kill', targetMobId: 'thornpeak_ogre', count: 12, label: 'Aetherthorn Yeti slain' }],
  ...
  q_ogre_bounty: {
    ...
    giverNpcId: 'captain_thessaly', turnInNpcId: 'captain_thessaly',
    text: "Maren's totems tell me all I need to know: the clans are bought, and my wall is their first errand. I will not wait for them to muster. Fourteen more Aetherthorn Yetis, $N — and I will pay bounty on every one.",
    completionText: 'Bounty paid in full. The foothills are quieter — now we deal with the ones doing the buying.',
    objectives: [{ type: 'kill', targetMobId: 'thornpeak_ogre', count: 14, label: 'Aetherthorn Yeti slain' }],
  ...
  q_crushers: {
    ...
    objectives: [{ type: 'kill', targetMobId: 'ogre_crusher', count: 10, label: 'Aetherthorn Yeti Crusher slain' }],
  ...
  q_drogmar: {
    ...
    giverNpcId: 'captain_thessaly', turnInNpcId: 'captain_thessaly',
    text: "Drogmar the Snowbrute took the Wyrmcult's coin and swore the clans to the mountain's waking. He is the hammer they mean to swing at my wall — and when he slams the ground, $N, do not be standing near him. Take your companions into the war-camp and end him, for Skyreach Bastion.",
  ...
  q_elementals: {
    ...
    giverNpcId: 'loremaster_caddis', turnInNpcId: 'loremaster_caddis',
    text: 'Stormspire Crag has stood silent a thousand years, and now the very stones of it get up and walk. Elementals do not simply wake, $N — something beneath this mountain is turning in its sleep. Put twelve of them down so I may study what remains.',
    completionText: 'The fragments hum like struck bells. The mountain is not angry, $N... it is being disturbed.',
    objectives: [{ type: 'kill', targetMobId: 'stormcrag_elemental', count: 12, label: 'Stormspire Crag Goleling slain' }],
  ...
  q_shard_cores: {
    ...
    giverNpcId: 'loremaster_caddis', turnInNpcId: 'loremaster_caddis',
    text: "At each Stormspire Crag Goleling's heart sits a storm core — a knot of lightning bound in stone. Six of them, set side by side, will tell me where the disturbance is centered. I suspect I already know, $N, and I dearly hope that I am wrong.",
    completionText: 'Each core leans the same way, like iron filings to a lodestone. They point south, $N. To the Sanctum.',
    objectives: [{ type: 'collect', itemId: 'storm_core', count: 6, label: 'Goleling Storm Core' }],
  ...
  q_kazzix: {
    ...
    giverNpcId: 'loremaster_caddis', turnInNpcId: 'loremaster_caddis',
    text: 'Among the elementals one burns brighter than the rest: Kazzix the Shard Goleling, a storm given shoulders. Its heartshard would anchor every reading I have taken — if you can wrench it from the thing. It walks the far crags west of Stormspire Crag, beyond the second camp.',
  ...
  q_cult_orders: {
    ...
    giverNpcId: 'brother_aldric_highwatch', turnInNpcId: 'brother_aldric_highwatch',
    text: 'The Wyrmcult Shadowblades move with purpose now — watches set, supplies counted, like soldiers before a siege. Cultists who organize are cultists taking orders, $N. Kill eight more and bring me four sets of Shadowblade Orders. I would know the hand that commands them.',
    completionText: "This script... I last saw its like in Morthen's grimoire, in Dawnmere. The same hand has guided every grave we have fought over, $N.",
    objectives: [
      { type: 'kill', targetMobId: 'wyrmcult_zealot', count: 8, label: 'Wyrmcult Shadowblade slain' },
      { type: 'collect', itemId: 'wyrmcult_orders', count: 4, label: 'Shadowblade Orders' },
    ],
  ...
  q_necromancers: {
    ...
    giverNpcId: 'brother_aldric_highwatch', turnInNpcId: 'brother_aldric_highwatch',
    text: 'The orders speak of a "ring of phylacteries" — soul-vessels, $N, set about the Sanctum to feed it. The Wyrmcult Hexblobs carry them like holy relics. Kill eight Hexblobs and bring me three Hexblob Phylacteries unbroken. I must know what souls they hold.',
    ...
    objectives: [
      ...
      { type: 'collect', itemId: 'ritual_phylactery', count: 3, label: 'Hexblob Phylactery' },
    ],
    xpReward: 4200, copperReward: 2200, itemRewards: {},
    requiresQuest: 'q_cult_orders', minLevel: 18,
  },
  q_revenants: {
    id: 'q_revenants', name: 'The Ashen Revenant Fields',
    giverNpcId: 'captain_thessaly', turnInNpcId: 'captain_thessaly',
  ...
  q_revenant_vanguard: {
    ...
    giverNpcId: 'captain_thessaly', turnInNpcId: 'captain_thessaly',
    text: 'The revenants are forming ranks, $N — true ranks, shield-lines and columns, drilling with no drummer. They are being mustered for the Sanctum gate. Break fourteen more before that march begins, and Skyreach Bastion will owe you its best steel.',
  ...
  q_breaking_the_seal: {
    ...
    objectives: [{ type: 'collect', itemId: 'blessed_embers', count: 5, label: 'Goleling Blessed Ember' }],
    xpReward: 4200, copperReward: 2200, itemRewards: {},
  ...
  q_voice_below: {
    ...
    giverNpcId: 'brother_aldric_highwatch', turnInNpcId: 'brother_aldric_highwatch',
    text: 'Last night the whole cult camp knelt at once, $N — every Shadowblade, every Hexblob, all facing the Sanctum. Korzul speaks to them in their sleep now; Vael heard the same voice in the fen, and Morthen before him. Cut the congregation down — ten Shadowblades, six Hexblobs — before that voice has hands enough to pull the gate open itself.',
  ...
  q_gravewyrm: {
    ...
    giverNpcId: 'brother_aldric_highwatch', turnInNpcId: 'brother_aldric_highwatch',
    text: 'There is no rite left to stop, $N — only the Wyrm itself, half-woken in its hollow, gorged on the dead of the Vale and the fen. If it rises, the wall, the marsh, Dawnmere — everything we have defended falls in a single night. Take your companions into the Wyrm\'s Hollow and finish what we began in a chapel yard so long ago. The Light has carried you this far; carry it the rest of the way.',
    completionText: 'It is over. The dead of three lands may rest, the mountain sleeps unhaunted — and it is your name, $N, that every bell from here to Dawnmere rings tonight.',
...
export const ZONE3_CAMPS: CampDef[] = [
  ...
  // Kobolds: Deepstone Burrows, west
  ...
  // Elementals: Stormspire Crag, far west
...
export const ZONE3_ITEMS: Record<string, ItemDef> = {
  // --- quest items ---
  highwatch_summons: { id: 'highwatch_summons', name: 'Skyreach Bastion Summons', kind: 'quest', sellValue: 0, questId: 'q_highwatch_summons' },
  ridge_stalker_pelt: { id: 'ridge_stalker_pelt', name: 'Ridge Blobdog Pelt', kind: 'quest', sellValue: 0, questId: 'q_stalker_pelts' },
  glowing_wax: { id: 'glowing_wax', name: 'Deepstone Cactoro Wax', kind: 'quest', sellValue: 0, questId: 'q_glowing_wax' },
  ogre_war_totem: { id: 'ogre_war_totem', name: 'Ogre War Totem', kind: 'quest', sellValue: 0, questId: 'q_ogre_totems' },
  storm_core: { id: 'storm_core', name: 'Goleling Storm Core', kind: 'quest', sellValue: 0, questId: 'q_shard_cores' },
  kazzix_heartshard: { id: 'kazzix_heartshard', name: "Kazzix's Heartshard", kind: 'quest', sellValue: 0, questId: 'q_kazzix' },
  wyrmcult_orders: { id: 'wyrmcult_orders', name: 'Shadowblade Orders', kind: 'quest', sellValue: 0, questId: 'q_cult_orders' },
  ritual_phylactery: { id: 'ritual_phylactery', name: 'Hexblob Phylactery', kind: 'quest', sellValue: 0, questId: 'q_necromancers' },
  gravewyrm_sigil: { id: 'gravewyrm_sigil', name: 'Gravewyrm Sigil', kind: 'quest', sellValue: 0, questId: 'q_wyrm_sigils' },
  blessed_embers: { id: 'blessed_embers', name: 'Goleling Blessed Ember', kind: 'quest', sellValue: 0, questId: 'q_breaking_the_seal' },
  ...
  trail_hardtack: {
    id: 'trail_hardtack', name: 'Skyreach Bastion Trail Hardtack', kind: 'food', quality: 'common',
  ...
  highwatch_warblade: {
    id: 'highwatch_warblade', name: 'Skyreach Bastion Warblade', kind: 'weapon', slot: 'mainhand', quality: 'common',
  ...
  highwatch_breastplate: {
    id: 'highwatch_breastplate', name: 'Skyreach Bastion Breastplate', kind: 'armor', slot: 'chest', quality: 'common',
...
// ---------------------------------------------------------------------------
// Static props (rendering + collision share this placement data). Skyreach Bastion
...
export const ZONE3_PROPS: ZonePropsDef = {
  ...
  mines: [{ x: 88, z: 612, rot: -2.0 }],             // Deepstone Burrows
  docks: [],
  tents: [
    // Drogmar's war-camp
  ...
  mudHuts: [],
  ruinRings: [
    { x: -40, z: 830, ringR: 7, columns: 6 },        // Ashen Revenant Fields battlefield
