...
const VAELORIA_PRIVY_CLIENT_ID = 'client-WY6Zbdn6w2DrhPLKCwJAQEurq8g7LjX89nxih2M4gCuCE';
  ...
  root.render(
    React.createElement(
      Provider,
      {
        ...
        config: {
          appearance: {
            logo: 'https://vaeloria-production.up.railway.app/vaeloria-wallet-icon-512.png',
