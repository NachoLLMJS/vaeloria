...
export const ZONE3_QUESTS: Record<string, QuestDef> = {
  ...
  q_kobold_tunnels: {
    ...
    text: 'The kobolds at Deepstone Burrows are digging deeper than any candle-rat has business digging — straight down, as if something were calling them. Their tunnels run beneath our wall, $N. Collapse the matter: kill twelve Deepstone Tunnelers.',
    completionText: 'Straight down, every shaft of it — kobolds do not dig like that on their own. I must consult my books.',
    objectives: [{ type: 'kill', targetMobId: 'deeprock_kobold', count: 12, label: 'Deepstone Tunneler slain' }],
